...
Ambisonic Icosahedron is an interactive spatial audio sculpture project, designed for creating immersive 3D audio experiences that the participant can actively take part in. Using a movement-sensing controller, the ambisonic audio sculpture presents itself equally distributed across an imaginary spherical surface. It is used to support artistic installations and research purposes.
