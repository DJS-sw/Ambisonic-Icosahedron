...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.638297080993652, 310.638295650482178, 74.0, 22.0 ],
					"text" : "unpack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.89361584186554, 418.085103392601013, 63.0, 22.0 ],
					"text" : "prepend 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.808509588241577, 394.680848240852356, 63.0, 22.0 ],
					"text" : "prepend 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.723403334617615, 370.21276330947876, 63.0, 22.0 ],
					"text" : "prepend 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.638297080993652, 352.127657055854797, 63.0, 22.0 ],
					"text" : "prepend 6"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 109.574467301368713, 455.319145679473877, 300.0, 100.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patching_rect" : [ 117.0, 121.0, 55.0, 22.0 ],
													"text" : "onebang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 179.0, 255.0, 56.0, 22.0 ],
													"text" : "metro 50"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 178.0, 231.0, 58.0, 22.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 143.0, 311.0, 50.0, 22.0 ],
													"text" : "select 1"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 143.0, 343.0, 24.0, 24.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"text" : "Yaw: 111.81 Pitch: 18.56 Roll: -78.06"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 873.0, 863.0, 142.5, 53.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.957989454269409, 402.0, 179.0, 36.0 ],
									"text" : "QuatW: 0.433 QuatX: 0.1652 QuatY: -0.6124 QuatZ: -0.6405"
								}
...
,
					"patching_rect" : [ 110.638297080993652, 142.553190469741821, 135.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-48::obj-171" : [ "vst~[3]", "vst~[3]", 0 ],
			"obj-48::obj-260" : [ "vst~[1]", "vst~[18]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
